...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dockerfile-mode jinja2-mode vue-mode helm org-ref php-mode web-mode session powerline multi-term markdown-mode magit js2-mode ido-grid-mode go-mode flycheck flx-ido find-file-in-repository elpy)))
