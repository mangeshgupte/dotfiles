...
(custom-set-variables
 ...
 '(package-selected-packages
   '(visual-fill-column yaml-mode web-mode vue-mode volatile-highlights valign session powerline php-mode org-ref olivetti nginx-mode multi-term markdown-mode magit js2-mode ido-grid-mode helm go-mode flycheck flx-ido find-file-in-repository elpy)))
(custom-set-faces
