;;; package -- .emacs dotfile  -*- mode: emacs-lisp; lexical-binding: t; -*-

;;; Code:

;; Keep Customize's auto-generated settings out of this hand-edited file.
...
;; ====================================================================
;; Load Customize-generated settings (faces, package-selected-packages).
